...
It is recommended using the provided Virtual Machine Image as Docker environment run seamlessly in Linux. Download Virtual Box Image: https://goo.gl/rBjsFk
